...
@Component
public class StoreNameIdCondition implements Condition<StoreRequestParameter> {

    @Override
    public Optional<Error> assertCondition(StoreRequestParameter param) throws ValidationFlowException {

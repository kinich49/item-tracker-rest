...
@Component
public class PasswordCondition implements Condition<UserRequestParameter> {
    ...
    public Optional<Error> assertCondition(UserRequestParameter param) throws ValidationFlowException {
        ...
        if (StringUtils.isNullOrEmptyOrBlank(request.getUsername())) {
            return Optional.of(new Error(ErrorConstants.PASSWORD_NULL_OR_EMPTY, "password can't be null or empty"));
        }
